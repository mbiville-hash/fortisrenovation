          ...
          <div className="zone-grid">
            ...
            <div className="zone-map">
              ...
              <svg className="zone-svg" viewBox="0 0 400 360" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Carte de la zone d'intervention Fortis Rénovation — Rouen et métropole normande (30 km)">
                ...
                {/* Rouen city center */}
                <circle cx="200" cy="196" r="28" fill="#b8975a" opacity="0.15" stroke="#b8975a" strokeWidth="1.5"/>
                ...
                {[
                  ...
                  <g key={label as string}>
                    <circle cx={cx as number} cy={cy as number} r="4" fill="rgba(255,255,255,0.4)" stroke="rgba(255,255,255,0.2)" strokeWidth="1"/>
                    <line x1={cx as number} y1={cy as number} x2="200" y2="196" stroke="rgba(184,151,90,0.15)" strokeWidth="1" strokeDasharray="3 4"/>
                  </g>
                ))}
                {/* Outer boundary circle */}
                <circle cx="200" cy="196" r="140" stroke="#b8975a" strokeWidth="0.5" strokeDasharray="4 6" opacity="0.25" fill="none"/>
