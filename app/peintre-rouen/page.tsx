...
const TITRE = 'Peintre à Rouen — travaux de peinture intérieure et enduits'
const DESC =
  'Travaux de peinture à Rouen : rénovation de murs intérieurs, plafonds, enduits et revêtements muraux. Particuliers, bailleurs et syndics. Devis gratuit sous 48h, chantier propre.'
...
export default function PeintreRouenPage() {
  return (
    <MetierPage
      slug={SLUG}
      nom="Peintre Rouen"
      schemaDescription="Travaux de peinture intérieure à Rouen : rénovation de murs et de plafonds, reprises d’enduits, revêtements muraux, parties communes de copropriété. Devis gratuit, chantier propre."
      eyebrow="Peinture, enduits & murs intérieurs · Rouen & métropole"
      titre={['Peintre à Rouen —', 'travaux de peinture et d’enduits.']}
      intro="Murs et plafonds repris, enduits rattrapés, pièces remises en peinture. Nous intervenons à Rouen et dans la métropole chez les particuliers comme pour les bailleurs et les syndics : une pièce à rafraîchir, un appartement complet, un logement entre deux locataires ou une cage d’escalier."
      promesses={[
      ...
      services={[
        ['Rénovation de murs intérieurs', 'Une pièce ou un appartement entier : lessivage, reprises de fond, sous-couche et finition sur murs et plafonds. Chez vous comme dans un logement à relouer.', '/remise-en-etat-locative-rouen'],
        ...
        ['Revêtements muraux', 'Papier peint, toile de verre, intissé : dépose de l’ancien revêtement, préparation du mur, pose et mise en peinture de la toile.'],
      ]}
      process={[
      ...
      faqs={[
        { q: 'Intervenez-vous chez les particuliers ?', a: 'Oui. Une chambre à rafraîchir, un salon, un appartement entier avant emménagement : nous prenons les chantiers de particuliers comme ceux des bailleurs. Nous passons voir, nous chiffrons sous 48h et nous vous donnons une date ferme.' },
        { q: 'Faites-vous les plafonds en plus des murs ?', a: 'Oui, et nous le conseillons : un plafond laissé tel quel se remarque immédiatement quand les murs sont refaits. Il est chiffré séparément sur le devis pour que vous puissiez arbitrer pièce par pièce.' },
      ...
      maillage={
        <>
          ...
          <Link href="/pose-de-sol-rouen" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>pose de parquet et de sols</Link>, le{' '}
          <Link href="/carreleur-rouen" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>carrelage</Link>, l’{' '}
      ...
      ctaTitre="Des murs à repeindre à Rouen ?"
