...
export const metadata: Metadata = {
  ...
  description: 'Plombier au Mesnil-Esnard : maintenance immobilière, dégâts des eaux, petits travaux. Intervention rapide sur le plateau est, rapport sous 48h. Devis gratuit.',
  alternates: { canonical: 'https://www.fortisrenovation.fr/plombier-le-mesnil-esnard' },
  openGraph: {
    title: 'Plombier Le Mesnil-Esnard — Fortis Rénovation',
    description: 'Maintenance immobilière et plomberie au Mesnil-Esnard. Intervention rapide, rapport sous 48h.',
...
const faqs = [
  {
    q: 'Intervenez-vous en urgence au Mesnil-Esnard ?',
  ...
  {
    q: 'Travaillez-vous avec les syndics et copropriétés au Mesnil-Esnard ?',
    a: 'Oui. Nous intervenons pour les syndics, bailleurs et particuliers du plateau est. Un interlocuteur unique, zéro relance.',
  },
]

export default function PlombierLeMesnilEsnardPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema(
        'Plombier Le Mesnil-Esnard',
        'Maintenance immobilière et plomberie au Mesnil-Esnard. Intervention rapide, rapport sous 48h.',
        '/plombier-le-mesnil-esnard'
      ))}} />
      ...
      <main style={{ paddingTop: 68 }}>
        ...
        <section style={{ background: 'var(--paper)', padding: '80px 0' }}>
          <div className="container">
            <h2 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 36, marginBottom: 16 }}>
              Nos interventions au Mesnil-Esnard
            </h2>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 20 }}>
              Commune résidentielle et commerçante du plateau est, Le Mesnil-Esnard mêle maisons, immeubles et locaux d'activité. Nous intervenons sur tous les corps de métier du bâtiment — plomberie, électricité courante, menuiserie, peinture, carrelage — avec un seul prestataire pour l'ensemble de votre parc.
            </p>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 48 }}>
              Sur l'axe de la route de Paris, on passe d'un dépannage chez un particulier le matin à une intervention sur les parties communes d'un immeuble l'après-midi, puis à une remise en état entre deux locataires. Cette polyvalence, c'est précisément ce qu'on apporte au Mesnil-Esnard : un seul interlocuteur pour tout votre parc, réponse sous 48h.
            </p>
          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 0 }}>
              {[
                ...
                ['3', 'Intervention planifiée', 'On intervient au moment qui vous convient, au Mesnil-Esnard et alentours.'],
        ...
        {/* TODO Marc-Antoine : remplace ce bloc par un VRAI avis d'un client du Mesnil-Esnard quand tu en as un. */}
        ...
        <section style={{ background: 'var(--paper)', padding: '56px 0' }}>
          <div className="container">
            ...
            <p style={{ fontSize: 13, color: 'var(--ink-soft)', lineHeight: 2, textAlign: 'center', marginTop: 12 }}>
              Vous rénovez votre salle de bain à Le Mesnil-Esnard ?{' '}
              <Link href="/salle-de-bain-le-mesnil-esnard" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>Découvrez notre offre salle de bain clé en main</Link>.
            </p>
          </div>
        </section>
