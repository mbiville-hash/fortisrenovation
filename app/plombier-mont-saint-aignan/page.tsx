...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Plombier Mont-Saint-Aignan — Fortis Rénovation',
    description: 'Maintenance immobilière et plomberie à Mont-Saint-Aignan. Intervention rapide, rapport sous 48h.',
    url: 'https://www.fortisrenovation.fr/plombier-mont-saint-aignan',
  },
}

const faqs = [
  {
    q: 'Intervenez-vous en urgence à Mont-Saint-Aignan ?',
  ...
  {
    q: 'Travaillez-vous avec les syndics à Mont-Saint-Aignan ?',
    a: 'Oui. Nous intervenons pour les syndics, bailleurs et particuliers. Un interlocuteur unique, zéro relance.',
  },
]

export default function PlombierMontSaintAignanPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema(
        'Plombier Mont-Saint-Aignan',
        'Maintenance immobilière et plomberie à Mont-Saint-Aignan. Intervention rapide, rapport sous 48h.',
        '/plombier-mont-saint-aignan'
      ))}} />
        ...
        <section style={{ background: 'var(--dark)', padding: '100px 0 80px', color: 'white' }}>
          <div className="container">
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--gold)', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              Mont-Saint-Aignan · Métropole normande
            </p>
            <h1 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 'clamp(36px, 5vw, 60px)', lineHeight: 1.1, marginBottom: 24 }}>
              Plombier à Mont-Saint-Aignan —<br />intervention rapide.
            </h1>
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.6)', maxWidth: 560, lineHeight: 1.75, marginBottom: 16 }}>
              Fortis Rénovation intervient à Mont-Saint-Aignan pour tous vos travaux de plomberie, maintenance immobilière et dégâts des eaux. Un interlocuteur unique, des rapports écrits à chaque intervention.
            </p>
        ...
        <section style={{ background: 'var(--paper)', padding: '80px 0' }}>
          <div className="container">
            <h2 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 36, marginBottom: 16 }}>
              Nos interventions à Mont-Saint-Aignan
            </h2>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 48 }}>
              Nous intervenons sur tous les corps de métier du bâtiment à Mont-Saint-Aignan et dans toute la métropole normande. Plomberie, électricité courante, menuiserie, peinture, carrelage — un seul prestataire pour l'ensemble de votre parc.
            </p>
          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 0 }}>
              {[
                ...
                ['3', 'Intervention planifiée', 'On intervient au moment qui vous convient, à Mont-Saint-Aignan et alentours.'],
        ...
        <section style={{ background: 'var(--paper)', padding: '72px 0' }}>
          <div className="container" style={{ maxWidth: 720, textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 22, lineHeight: 1.6, color: 'var(--ink)', marginBottom: 24 }}>
              Très professionnel, toujours disponible et le travail est impeccable. Je fais appel à eux pour tous mes biens à Mont-Saint-Aignan.
            </p>
            <p style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink-soft)', letterSpacing: '0.06em' }}>[Prénom] — Propriétaire, Mont-Saint-Aignan</p>
