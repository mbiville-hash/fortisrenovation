...
const PARC = getParcPlomberie('sotteville-les-rouen')!

export const metadata: Metadata = {
  title: 'Plombier Sotteville-lès-Rouen — Maintenance & dégât des eaux',
  description: 'Plombier à Sotteville-lès-Rouen : maintenance immobilière, dégâts des eaux, petits travaux. Intervention rapide, rapport sous 48h. Devis gratuit.',
  alternates: { canonical: 'https://www.fortisrenovation.fr/plombier-sotteville-les-rouen' },
  openGraph: {
...
const faqs = [
  {
    q: 'Intervenez-vous en urgence à Sotteville-lès-Rouen ?',
  ...
  {
    q: 'Travaillez-vous avec les syndics à Sotteville-lès-Rouen ?',
    a: 'Oui. Nous intervenons pour les syndics, bailleurs et particuliers. Un interlocuteur unique, zéro relance.',
  },
]

export default function PlombierSottevillePage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema(
        'Plombier Sotteville-lès-Rouen',
        'Maintenance immobilière et plomberie à Sotteville-lès-Rouen. Intervention rapide, rapport sous 48h.',
        '/plombier-sotteville-les-rouen'
      ))}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema([
        ...
        { name: 'Plombier Sotteville-lès-Rouen', url: 'https://www.fortisrenovation.fr/plombier-sotteville-les-rouen' },
      ]))}} />
      ...
      <main style={{ paddingTop: 68 }}>
        ...
        <section style={{ background: 'var(--paper)', padding: '80px 0' }}>
          <div className="container" data-reveal>
            <h2 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 36, marginBottom: 16 }}>
              Nos interventions à Sotteville-lès-Rouen
            </h2>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 48 }}>
              Nous intervenons sur tous les corps de métier du bâtiment à Sotteville-lès-Rouen et dans toute la métropole normande. Plomberie, électricité courante, menuiserie, peinture, carrelage — un seul prestataire pour l'ensemble de votre parc.
            </p>
          ...
          <div className="container" data-reveal>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 0 }}>
              {[
                ...
                ['3', 'Intervention planifiée', 'On intervient au moment qui vous convient, à Sotteville-lès-Rouen et alentours.'],
        ...
        {/* TODO Marc-Antoine : remplace ce bloc par un VRAI avis d'un client de Sotteville-lès-Rouen quand tu en as un. */}
        <section style={{ background: 'var(--paper)', padding: '72px 0' }}>
          <div className="container" data-reveal style={{ maxWidth: 720, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-soft)', lineHeight: 1.75 }}>
              Une intervention à Sotteville-lès-Rouen ou dans la métropole ? Demandez-nous les coordonnées de clients du secteur : on les communique volontiers.
            </p>
          </div>
        </section>
        ...
        <section style={{ background: 'var(--paper)', padding: '56px 0' }}>
          <div className="container" data-reveal>
            ...
            <p style={{ fontSize: 13, color: 'var(--ink-soft)', lineHeight: 2, textAlign: 'center', marginTop: 12 }}>
              Vous gérez des logements à Sotteville-lès-Rouen ?{' '}
              <Link href="/maintenance-immobiliere-sotteville-les-rouen" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>Découvrez notre offre de maintenance immobilière</Link>.
            </p>
          </div>
        </section>
        ...
        <section style={{ background: 'var(--dark)', padding: '72px 0', color: 'white', textAlign: 'center' }}>
          <div className="container" data-reveal>
            <h2 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 36, marginBottom: 16, color: 'white' }}>
              Un besoin à Sotteville-lès-Rouen ?
            </h2>
