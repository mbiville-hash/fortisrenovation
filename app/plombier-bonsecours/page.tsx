...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Plombier Bonsecours — Fortis Rénovation',
    description: 'Maintenance immobilière et plomberie à Bonsecours. Intervention rapide, rapport sous 48h.',
...
const faqs = [
  {
    q: 'Intervenez-vous en urgence à Bonsecours ?',
  ...
  {
    q: 'Travaillez-vous avec les syndics et copropriétés à Bonsecours ?',
    a: 'Oui. Nous intervenons pour les syndics, bailleurs et particuliers du plateau est. Un interlocuteur unique, zéro relance.',
  },
]

export default function PlombierBonsecoursPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema(
        'Plombier Bonsecours',
        'Maintenance immobilière et plomberie à Bonsecours. Intervention rapide, rapport sous 48h.',
        '/plombier-bonsecours'
      ))}} />
        ...
        <section style={{ background: 'var(--dark)', padding: '100px 0 80px', color: 'white' }}>
          <div className="container" data-reveal>
            ...
            <h1 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 'clamp(36px, 5vw, 60px)', lineHeight: 1.1, marginBottom: 24 }}>
              Plombier à Bonsecours — <br />intervention rapide.
            </h1>
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.6)', maxWidth: 560, lineHeight: 1.75, marginBottom: 16 }}>
              Fortis Rénovation intervient à Bonsecours et sur le plateau est pour tous vos travaux de plomberie, maintenance immobilière et dégâts des eaux. Un interlocuteur unique, des rapports écrits à chaque intervention.
            </p>
        ...
        <section style={{ background: 'var(--paper)', padding: '80px 0' }}>
          <div className="container" data-reveal>
            ...
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 20 }}>
              Le long de la route de Paris comme dans les quartiers résidentiels, nous intervenons à Bonsecours sur tous les corps de métier du bâtiment : copropriétés, pavillons, biens locatifs. Plomberie, électricité courante, menuiserie, peinture, carrelage — un seul prestataire, une seule facture.
            </p>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 48 }}>
              Perchée sur le plateau est au-dessus de Rouen, près de la basilique Notre-Dame, Bonsecours aligne pavillons et petites copropriétés le long de la route de Paris. Les demandes récurrentes : fuites, dégâts des eaux entre étages, remplacement de sanitaires. On gère l'ensemble avec un interlocuteur unique et un compte rendu systématique, utile pour les syndics.
            </p>
          ...
          <div className="container" data-reveal>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 0 }}>
              {[
                ...
                ['3', 'Intervention planifiée', 'On intervient au moment qui vous convient, à Bonsecours et alentours.'],
