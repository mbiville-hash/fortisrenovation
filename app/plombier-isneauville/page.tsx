...
const PARC = getParcPlomberie('isneauville')!

export const metadata: Metadata = {
  title: 'Plombier Isneauville — Maintenance & dégât des eaux',
  description: 'Plombier à Isneauville : maintenance immobilière, dégâts des eaux, petits travaux. Intervention rapide sur le plateau nord, rapport sous 48h. Devis gratuit.',
  alternates: { canonical: 'https://www.fortisrenovation.fr/plombier-isneauville' },
  openGraph: {
    title: 'Plombier Isneauville — Fortis Rénovation',
    description: 'Maintenance immobilière et plomberie à Isneauville. Intervention rapide, rapport sous 48h.',
    url: 'https://www.fortisrenovation.fr/plombier-isneauville',
    locale: 'fr_FR',
    type: 'website',
    images: OG_IMAGE,
  },
...
const faqs = [
  {
    q: 'Intervenez-vous en urgence à Isneauville ?',
    a: "Oui. Pour les urgences (fuite, dégât des eaux), contactez-nous directement au 07 67 49 13 24. Nous organisons l'intervention le plus rapidement possible sur le secteur nord.",
  },
  {
  ...
  {
    q: 'Intervenez-vous sur les maisons individuelles et résidences récentes ?',
    a: "Oui. Isneauville compte beaucoup de pavillons et de résidences récentes : nous traitons aussi bien l'entretien d'une maison que la maintenance d'une copropriété ou d'un bien locatif.",
  },
]

export default function PlombierIsneauvillePage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema(
        'Plombier Isneauville',
        'Maintenance immobilière et plomberie à Isneauville. Intervention rapide, rapport sous 48h.',
        '/plombier-isneauville'
      ))}} />
      ...
      <main style={{ paddingTop: 68 }}>
        ...
        <section style={{ background: 'var(--paper)', padding: '80px 0' }}>
          <div className="container" data-reveal>
            <h2 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 36, marginBottom: 16 }}>
              Nos interventions à Isneauville
            </h2>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 20 }}>
              Maisons individuelles, résidences récentes, biens locatifs : à Isneauville nous intervenons sur tous les corps de métier du bâtiment. Plomberie, électricité courante, menuiserie, peinture, carrelage — un seul prestataire, une seule facture, pour l'entretien comme pour les imprévus.
            </p>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 48 }}>
              Isneauville s'est étendue avec des lotissements et des résidences récentes autour de la Plaine de la Ronce. Sur ce bâti plus neuf, on intervient surtout pour de l'entretien, du remplacement d'équipements et des finitions — avec le niveau de propreté et de ponctualité qu'attend une clientèle de propriétaires exigeants.
            </p>
          ...
          <div className="container" data-reveal>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 0 }}>
              {[
                ...
                ['3', 'Intervention planifiée', 'On intervient au moment qui vous convient, à Isneauville et alentours.'],
        ...
        {/* TODO Marc-Antoine : remplace ce bloc par un VRAI avis d'un client d'Isneauville quand tu en as un. */}
        <section style={{ background: 'var(--paper)', padding: '72px 0' }}>
          <div className="container" data-reveal style={{ maxWidth: 720, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-soft)', lineHeight: 1.75 }}>
              Une intervention à Isneauville ou sur le plateau nord ? Demandez-nous les coordonnées de clients du secteur : on les communique volontiers.
            </p>
          </div>
        </section>
        ...
        <section style={{ background: 'var(--paper)', padding: '56px 0' }}>
          <div className="container" data-reveal>
            ...
            <p style={{ fontSize: 13, color: 'var(--ink-soft)', lineHeight: 2, textAlign: 'center', marginTop: 12 }}>
              Vous rénovez votre salle de bain à Isneauville ?{' '}
              <Link href="/salle-de-bain-isneauville" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>Découvrez notre offre salle de bain clé en main</Link>.
            </p>
          </div>
        </section>
