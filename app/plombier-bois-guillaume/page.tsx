...
const PARC = getParcPlomberie('bois-guillaume')!

export const metadata: Metadata = {
  title: 'Plombier Bois-Guillaume — Maintenance & dégât des eaux',
  description: 'Plombier à Bois-Guillaume : maintenance immobilière, dégâts des eaux, petits travaux. Intervention rapide, rapport sous 48h. Devis gratuit.',
  alternates: { canonical: 'https://www.fortisrenovation.fr/plombier-bois-guillaume' },
  openGraph: {
    title: 'Plombier Bois-Guillaume — Fortis Rénovation',
    description: 'Maintenance immobilière et plomberie à Bois-Guillaume. Intervention rapide, rapport sous 48h.',
    url: 'https://www.fortisrenovation.fr/plombier-bois-guillaume',
    locale: 'fr_FR',
    type: 'website',
    images: OG_IMAGE,
  },
...
const faqs = [
  {
    q: 'Intervenez-vous en urgence à Bois-Guillaume ?',
    a: "Oui. Pour les urgences (fuite, dégât des eaux), contactez-nous directement au 07 67 49 13 24. Nous organisons l'intervention le plus rapidement possible.",
  },
  {
  ...
  {
    q: 'Travaillez-vous avec les syndics à Bois-Guillaume ?',
    a: 'Oui. Nous intervenons pour les syndics, bailleurs et particuliers. Un interlocuteur unique, zéro relance.',
  },
]

export default function PlombierBoisGuillaumePage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema(
        'Plombier Bois-Guillaume',
        'Maintenance immobilière et plomberie à Bois-Guillaume. Intervention rapide, rapport sous 48h.',
        '/plombier-bois-guillaume'
      ))}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema([
        ...
        { name: 'Plombier Bois-Guillaume', url: 'https://www.fortisrenovation.fr/plombier-bois-guillaume' },
      ]))}} />
      ...
      <main style={{ paddingTop: 68 }}>
        ...
        <section style={{ background: 'var(--dark)', padding: '100px 0 80px', color: 'white' }}>
          <div className="container" data-reveal>
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--gold)', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              Bois-Guillaume · Métropole normande
            </p>
            <h1 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 'clamp(36px, 5vw, 60px)', lineHeight: 1.1, marginBottom: 24 }}>
              Plombier à Bois-Guillaume — <br />intervention rapide.
            </h1>
            <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.6)', maxWidth: 560, lineHeight: 1.75, marginBottom: 16 }}>
              Fortis Rénovation intervient à Bois-Guillaume pour tous vos travaux de plomberie, maintenance immobilière et dégâts des eaux. Un interlocuteur unique, des rapports écrits à chaque intervention.
            </p>
        ...
        <section style={{ background: 'var(--paper)', padding: '80px 0' }}>
          <div className="container" data-reveal>
            <h2 style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 36, marginBottom: 16 }}>
              Nos interventions à Bois-Guillaume
            </h2>
            <p style={{ fontSize: 15, color: 'var(--ink-soft)', maxWidth: 600, lineHeight: 1.75, marginBottom: 48 }}>
              Nous intervenons sur tous les corps de métier du bâtiment à Bois-Guillaume et dans toute la métropole normande. Plomberie, électricité courante, menuiserie, peinture, carrelage — un seul prestataire pour l'ensemble de votre parc.
            </p>
          ...
          <div className="container" data-reveal>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 0 }}>
              {[
                ...
                ['3', 'Intervention planifiée', 'On intervient au moment qui vous convient, à Bois-Guillaume et alentours.'],
        ...
        {/* TODO Marc-Antoine : remplace ce bloc par un VRAI avis d'un client de Bois-Guillaume quand tu en as un. */}
        <section style={{ background: 'var(--paper)', padding: '72px 0' }}>
          <div className="container" data-reveal style={{ maxWidth: 720, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 14, color: 'var(--ink-soft)', lineHeight: 1.75 }}>
              Une intervention à Bois-Guillaume ou sur le plateau nord ? Demandez-nous les coordonnées de clients du secteur : on les communique volontiers.
            </p>
          </div>
        </section>
        ...
        <section style={{ background: 'var(--paper)', padding: '56px 0' }}>
          <div className="container" data-reveal>
            ...
            <p style={{ fontSize: 13, color: 'var(--ink-soft)', lineHeight: 2, textAlign: 'center', marginTop: 12 }}>
              ...
              <Link href="/salle-de-bain-bois-guillaume" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>Découvrez notre offre salle de bain clé en main</Link>.
            </p>
          </div>
        </section>
