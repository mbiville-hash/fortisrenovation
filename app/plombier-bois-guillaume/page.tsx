        ...
        <section style={{ background: 'var(--paper)', padding: '72px 0' }}>
          <div className="container" style={{ maxWidth: 720, textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: "'Bodoni Moda', serif", fontSize: 22, lineHeight: 1.6, color: 'var(--ink)', marginBottom: 24 }}>
              Sérieux, ponctuel, et le travail est bien fait. Rapport envoyé dans la journée. C'est exactement ce qu'on cherche pour notre immeuble.
            </p>
            <p style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink-soft)', letterSpacing: '0.06em' }}>[Prénom] — Propriétaire, Bois-Guillaume</p>
